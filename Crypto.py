...
SID = ' SID code here '
Auth_Token = ' Authentication Code here'
...
if url_check:
    ...
    if  final_price > limit:
        ...
        message= variable.messages.create(body="Congrats its greater then your trigger value", from_=' sender number', to=' receiver number ')
